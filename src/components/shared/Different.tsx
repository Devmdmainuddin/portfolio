...
const Different = () => {
  const different=[
    { id:1,
      ...
      description: "I bring your ideas to life with designs that are one-of-a-kind, visually stunning, and aligned with your brand’s identity. Every detail is meticulously crafted to stand out from the competition.",
      image: "/software.gif",
    },
    { id:2,
  ...
  return (
    <div className="my-[120px]">
      <Container>
        ...
        <h2 className="text-3xl font-light tracking-[3px] uppercase text-[#282828] ">Why I&apos;m Different?</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-[50px]">
          {different.map((Item,idx)=><div key={idx} className="borderTrail hover:shadow-[rgba(17,_17,_26,_0.1)_0px_8px_24px,_rgba(17,_17,_26,_0.1)_0px_16px_56px,_rgba(17,_17,_26,_0.1)_0px_24px_80px] transition-all duration-500">
            <div className="image">
              <Image
                src={Item.image}
                alt="Image"
